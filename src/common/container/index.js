    ...
    return (
      <Layout className="containAll">
        <Sider
          ...
          className="leftMenu"
        >
          {this.state.theme === 'light' ? <a href="#" target='_blank' rel='noopener noreferrer'><Icon type="ant-design" className="ant-design" /></a> :
            <a href="#" target='_blank' rel='noopener noreferrer'><Icon type="ant-design" className="ant-design white" /></a> }
          { this.state.theme === 'light' ? <span className="author">jr.chen</span> : <span className="author white">jr.chen</span> }
          <Menu
